          ...
          <Form :model="formItem">
            ...
            <FormItem>
              <div class="single">
                ...
                <div class="account">
                  <div class="line" @click="register">注册 XMall 账号</div>
                  <div>忘记密码 ?</div>
                </div>
              </div>
            </FormItem>
            ...
            <FormItem>
              <div class="long">
                ...
                <div class="primary">
                  <Button long @click="Return">返回</Button>
                </div>
              </div>
              <!-- 其它账号登录 -->
              <div class="other">
                <div>其它账号登录：</div>
                <img src="../assets/wechat.svg" alt class="wechat" />
                <img src="../assets/sina.svg" alt class="wechat" />
                <img src="../assets/qq.svg" alt class="wechat" />
              </div>
            </FormItem>
          </Form>
        </div>
...
export default {
  ...
  methods: {
    ...
    Signin() {
      this.$api
        .login(this.formItem.name,this.formItem.passwd)
        .then(res => {
          console.log(res);
        })
        .catch(err => {
